...
public class SplitOutboundTest extends ApiTest {
    ...
    void splitOutboundSetUp() {
        ...
        Scenario.createLocation().locationBarcode(locationBarcode).request()
                .createInbound().products(
                        new CreateInbound.Request.Product(
                                1L,
                                2_000L,
                                15_000L,
                                "블랙핑크 1집 앨범[]"
                ...
                .registerInboundProductInspectionResult().inboundProductNo(2L).request()
                .createLPN().inboundProductNo(1L).lpnBarcode("LPN-001").request()
                .createLPN().inboundProductNo(2L).lpnBarcode("LPN-002").request();
