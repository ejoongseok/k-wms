...
public class AdjustInventoryView {
    private final LocationRepository locationRepository;
    private final InventoryRepository inventoryRepository;

    @GetMapping("/web/locations/{locationNo}/adjust-inventories/{inventoryNo}")
    @Transactional(readOnly = true)
    public String adjustInventoryView(
        ...
        return "location/adjust-inventory";
    }
